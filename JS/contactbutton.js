...
firstPlatform.addEventListener('click',()=>{
    window.open("https://twitter.com/ParamSingh1303");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:paramhanssingh084@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/Paramhans-Singh");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/paramhans-singh-559419232/");
});